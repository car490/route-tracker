-- Extend get_duty_card to return operator branding colours.
-- These are used by the onboard passenger display (onboard.js) to inject
-- --operator-primary / --operator-accent CSS vars, mirroring the pattern
-- that ThemeProvider uses in the dashboard.
-- No schema change — companies.primary_color / accent_color already exist.
