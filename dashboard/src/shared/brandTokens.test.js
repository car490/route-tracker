...
// typeface (see docs/BRAND.md). dashboard/index.html's Google Fonts <link>
// is static — Vite doesn't template index.html's <head> — so it can't
// import the CSS token; this guards it from drifting out of sync instead.
