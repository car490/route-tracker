...
| Offline resilience for end-of-trip uploads | **Shipped 2026-08-23** — failed stop-time/`complete_journey` calls are queued locally and auto-retried on reconnect. **No UI indicator yet** for a driver/ops to see the queue — still open. | `docs/TODO.md` "Offline resilience" |
