...
| Interior display ceiling-drop mount (production) | **RAM Mounts E-size (3.38" ball) double-ball VESA system** — face plate + ceiling base + short double-socket arm, chosen for harsh-environment vibration resistance. **Corrected 2026-08-14 from an earlier D-size pick**: D-size is only rated to 6 lb/2.72kg dynamic per RAM's own spec, and the P2426H panel alone (used here as a size/weight proxy — see §3) weighs 6.88 lb/3.12kg without its stand, already over D-size's rating before an enclosure is added. E-size (rated to 15 lb/6.8kg dynamic) has real headroom for panel + enclosure. Exact SKUs TBD — depend on the final production panel's weight/VESA pattern (§3) and the ceiling void's attachment point (stud/rail/plate) | **Mount family corrected to E-size 2026-08-14, exact parts TBD** — also depends on the undetermined production display panel (§3) |
| Interior display enclosure mount (BETA, Dell Pro P2426H) | Same **RAM E-size VESA system** as above, ordered now against the bare panel's confirmed 100×100mm VESA holes: **RAM-E-246U** (VESA plate w/ E-size ball, or **RAM-E-246U-IN1** steel-reinforced) + **RAM-E-202U** (round base w/ E-size ball, or **RAM-E-202U-IN1** steel-reinforced) + **RAM-E-201U-D** (short double socket arm, 7.31" overall — shortest E-size arm RAM makes, for rigidity under vibration). Steel-reinforced plate/base recommended given this is overhead in a moving vehicle. All three at [RAM Mounts UK](https://www.ram-mount.co.uk/). If vibration testing shows resonance, RAM's **Vibe-Safe** add-on puck gives supplemental damping on top of the standard ball-and-socket joint — no confirmed buy link found yet, only chase if needed | **Corrected to E-size + exact SKUs identified 2026-08-14** — order ASAP for next week's BETA test (§3) |
...
| **Interior display enclosure — VESA passthrough requirement** | The enclosure's back panel **must** expose a 100×100mm VESA passthrough aligned to the panel's own native mounting holes, not bury the panel behind a solid back | **Firm requirement, 2026-08-14** — lets the same RAM E-size mount hardware (rows above) bolt to the bare P2426H for BETA now, then unbolt/rebolt straight to the enclosure later with no new mount purchase. If the enclosure design instead hides or offsets the VESA holes, the mount has to be bought twice — flag to whoever builds the enclosure before fabrication starts. Re-check E-size's 15 lb/6.8kg dynamic rating once the enclosure's actual weight and mounting depth are known — expected to have headroom, but not yet verified. |
